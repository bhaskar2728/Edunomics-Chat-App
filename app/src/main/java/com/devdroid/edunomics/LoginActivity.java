...
import com.devdroid.edunomics.Adapters.DisplayUsersAdapter;
...
public class LoginActivity extends AppCompatActivity {
    ...
    EditText edtEmail,edtPassword,edtEmailReset,edtEmailConfirmReset;
    TextView txtSignup,fgtPassword,txtReset;
    ImageView img1,img2,imgClose;
    ...
    public void ForgotPassword() {
        ...
        final View bottomSheetView = LayoutInflater.from(this).inflate(R.layout.bottom_dialog,(RelativeLayout)findViewById(R.id.bottomSheetContainer));

        edtEmailReset = bottomSheetView.findViewById(R.id.edtEmail);
        edtEmailConfirmReset = bottomSheetView.findViewById(R.id.edtEmailConfirm);
        txtReset = bottomSheetView.findViewById(R.id.txtReset);
        ...
        txtReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                !edtEmailReset.getText().toString().equals(edtEmailConfirmReset.getText().toString())){
